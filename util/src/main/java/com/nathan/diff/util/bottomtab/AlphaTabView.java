package com.nathan.diff.util.bottomtab;
...
public class AlphaTabView extends View {
    ...
    public AlphaTabView(Context context, String mText, int mTextSize, int mTextColorSelected, int mTextColorNormal, int mPadding, Bitmap mIconSelected, Bitmap mIconNormal) {
        super(context);
