...
public class BackgroundDarkPopupWindow extends PopupWindow {
    ...
    /**
     * 是否关闭点击阴影时关闭popupwindow的设置
     */
    private boolean isCloseDarkClick = true;
    ...
    /**
     * 由于设置了点击阴影不关闭，那么dismiss正常来是关不了的，所以要手动关一波
     */
    ...
    /**
     * 控制关闭阴影点击后是否消失
     * @param closeDarkClick
     */
    public void setCloseDarkClick(boolean closeDarkClick) {
        isCloseDarkClick = closeDarkClick;
    }

    //用于在关闭popupwindow时调用
    OnDismissListener dissLister = new OnDismissListener() {
        @Override
    ...
    public void setDismissListener(OnDismissListener dissLister){
        this.dissLister = dissLister;
    }
